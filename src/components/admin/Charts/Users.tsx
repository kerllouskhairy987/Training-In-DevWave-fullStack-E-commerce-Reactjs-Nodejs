...
const UsersChart: React.FC = () => {
  ...
  const optionsList: string[] = ["Yesterday", "Today", "Last 7 days", "Last 30 days", "Last 90 days"];
  ...
  const chartOptions: ApexOptions = {
    ...
    grid: { show: false, strokeDashArray: 4, padding: { left: 2, right: 2, top: 0, bottom: 0 } },
    xaxis: {
  ...
  const series = [
    { name: "New Visitors", data: [6500, 6418, 6456, 6526, 6356, 6456], color: "#1A56DB" },
  ];
  ...
  return (
    <div className="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
      <div className="flex justify-between">
        <div>
          <h5 className="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">5.8k</h5>
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">Visitors this week</p>
        </div>
      ...
      <div className="grid grid-cols-1 items-center border-t border-gray-200 dark:border-gray-700 pt-5">
        <div className="relative flex justify-between items-center" ref={dropdownRef}>
          <button
          ...
          >
            {selectedOption}
            <svg className="w-2.5 ml-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
